      ...
      <div className="rounded-sm border-stroke bg-white dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full xl:w-1/2">
            <div className="py-17.5 px-10">
              <h4 className="mb-11 text-3xl font-bold text-black dark:text-black">
                Welcome Back
              </h4>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="mb-6">
                  <label
                    htmlFor="gstin"
                    className="mb-3 block text-base font-medium text-black dark:text-black"
                  >
                    GSTIN No
                  </label>
                ...
                <div className="mb-6 flex items-center justify-between">
                  <Link
                    to="/"
                    className="text-base font-medium text-primary hover:underline dark:text-black"
                  >
                    Forgot Password?
                  </Link>
                </div>
              ...
              <p className="mt-8 text-center text-base font-medium text-body dark:text-black">
